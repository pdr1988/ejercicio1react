...
const ItemListContainer = ({mensaje, user, compra, precio}) => {
    ...
    useEffect(()=>{
        let pago = new Promise((res,rej)=>{
           setTimeout(()=>{
            res([{id: 0, name: "HELADERA", precio:"1000", desc: "SAMSUNG NO FROST", category: "samsung" ,picURL: "https://rodo.com.ar/media/catalog/product/cache/1/image/1800x/040ec09b1e35df139433887a97daa66f/3/4/348870_1.jpg"},
            ...
            {id: 3, name: "TELEVISOR", precio:"200", desc: "TV 55 PULGADAS SAMSUNG", category: "samsung" ,picURL:"https://th.bing.com/th/id/R.51e618f291fe6b1b815dfcb68f50e56c?rik=oMJW%2bhDALq%2b6tQ&pid=ImgRaw&r=0"},
